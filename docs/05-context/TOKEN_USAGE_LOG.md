...
| SPEC-0023 | 4.041.749 | 769.726 | 509.544 | 953.157 | 641.550 | 1.781.328 | 0 |
...
| SPEC-0023 | 953.157 | 7.743.897 | 8.1× |

## Como estimar antes de começar uma SPEC nova

- SPECs concluídas (`Done`) até agora: 22. Custo médio: **10.238.485 tokens efetivos**. Faixa observada: 3.308.128 – 35.026.030 tokens efetivos.
