...
| SPEC-0021 | 7.533.130 | 643.430 | 1.445.130 | 1.221.015 | 470.358 | 0 |
| SPEC-0022 | 1.738.613 | 0 | 648.237 | 971.524 | 763.306 | 0 |

## Como estimar antes de começar uma SPEC nova

- SPECs concluídas (`Done`) até agora: 20. Custo médio: **10.505.370 tokens efetivos**. Faixa observada: 3.308.128 – 35.026.030 tokens efetivos.
