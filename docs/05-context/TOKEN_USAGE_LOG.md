...
| SPEC-0021 | 7.533.130 | 0 | 1.445.130 | 1.221.015 | 470.358 | 0 |

## Como estimar antes de começar uma SPEC nova

- SPECs concluídas (`Done`) até agora: 20. Custo médio: **10.473.199 tokens efetivos**. Faixa observada: 3.308.128 – 35.026.030 tokens efetivos.
