...
| SPEC-0023 | 2.062.833 | 769.726 | 509.544 | 953.157 | 641.550 | 1.781.328 | 0 |
...
| SPEC-0023 | 953.157 | 5.764.981 | 6.0× |

## Como estimar antes de começar uma SPEC nova

- SPECs concluídas (`Done`) até agora: 22. Custo médio: **10.148.535 tokens efetivos**. Faixa observada: 3.308.128 – 35.026.030 tokens efetivos.
