...
| SPEC-0020 | 4.030.323 | 1.479.607 | 816.702 | 2.651.780 | 911.089 | 0 | 0 |
| SPEC-0021 | 7.533.130 | 643.430 | 1.445.130 | 1.221.015 | 470.358 | 0 | 0 |
| SPEC-0022 | 2.576.468 | 769.726 | 1.157.781 | 971.524 | 763.306 | 2.375.728 | 0 |
| SPEC-0023 | 1.415.096 | 0 | 0 | 953.157 | 641.550 | 209.623 | 0 |

## Como estimar antes de começar uma SPEC nova

- SPECs concluídas (`Done`) até agora: 21. Custo médio: **10.415.330 tokens efetivos**. Faixa observada: 3.308.128 – 35.026.030 tokens efetivos.
